...
export function Achievements() {
    ...
    return (
        <section id="achievements" className="snap-major section-x relative py-16 sm:py-24">
                            ...
                            <GlassCard className="lift group relative overflow-hidden p-0">
                                <div className="relative z-10 aspect-[16/9] w-full overflow-hidden rounded-t-[23px]">
                                    ...
                                    <div className="absolute right-4 top-4">
                                        <span className="grid h-9 w-9 place-items-center rounded-full border backdrop-blur-md"
                                            style={{ borderColor: "var(--glass-border-strong)", background: "var(--surface-translucent)", color: "var(--color-1)" }}>
                                ...
                                <div className="relative p-5 sm:p-6">
                                    <h3 className="text-lg font-semibold tracking-tight text-[var(--color-1)]">{a.title}</h3>
                                    <p className="mt-1 text-xs text-[var(--text-muted)]">{a.subtitle}</p>
